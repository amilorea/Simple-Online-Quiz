function welcomeMaker(role, name){
	...
	document.getElementById('left-welcome').classList.value = '';
...
function menuMaker(role){
	...
	if(role === _ROLE.GUEST){
		...
		str += '<div class="mini menu-button" onclick="loadMiddlePage(\'profile.html\', function(){ return loadProfile() })">Cá nhân</div>';
